...
import static com.moecheng.cyborgcare.statusbar.StatusBarView.addStatusBarView;
    ...
    private void windowConfig() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (TintType.PURECOLOR == mTintType) {
                ...
                mActivity.getWindow().setStatusBarColor(Compat.calculateColorWithAlpha(mStatusBarColor, mAlpha));//设置状态栏颜色
