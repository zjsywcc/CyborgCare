...
package com.moecheng.cyborgcare.bluetooth;
...
import com.moecheng.cyborgcare.profile.BluetoothActivity;
...
public class DeviceConnector {
    ...
    public synchronized void connected(BluetoothSocket socket) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothActivity.MESSAGE_DEVICE_NAME, deviceName);
...
//                    }
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.obtainMessage(BluetoothActivity.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
