...
public class Tabbar extends RelativeLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public void initView() {
        ...
        RelativeLayout.LayoutParams lineParams = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, context.getResources().getDimensionPixelSize(R.dimen.WHTabbarLineHeight));
